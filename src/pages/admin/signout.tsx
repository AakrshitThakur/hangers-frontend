...
export default function AdminSignOut() {
  ...
  return (
    <div className="relative min-h-[65vh] sm:min-h-[75vh] md:min-h-[85vh] w-full max-w-7xl color-base-100 color-base-content bg-[url('/images/admin.png')] bg-cover bg-center bg-no-repeat">
      <div className="absolute inset-0 z-45 bg-[rgba(0,0,0,0.15)] overflow-hidden flex items-center justify-center p-5">
        <div className="color-base-300 color-base-content w-full max-w-md space-y-5 p-5 rounded-2xl">
          {/* Header */}
